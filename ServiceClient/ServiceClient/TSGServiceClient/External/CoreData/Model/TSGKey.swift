...
// Insert code here to add functionality to your managed object subclass
    ...
    class func allParameters( arrayDict:AnyObject!, context:NSManagedObjectContext) -> NSSet{
        ...
        let keyEntity = NSEntityDescription.entityForName("TSGKey",
                                                          inManagedObjectContext: context)

        for object in arrayDict as! NSMutableArray {
            
            let keyObj:TSGKey = NSManagedObject(entity: keyEntity!, insertIntoManagedObjectContext: context) as! TSGKey
